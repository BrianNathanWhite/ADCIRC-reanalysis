...
p9 <- df_mean_ADCIRC %>%
  ...
  ggplot(aes(x = TIME, y = WrightsvilleBeach)) +
  geom_point(col = 'blue', size = 0.5) +
  labs(x = 'Day', y = 'Sea-level (m)', title = 'ADCIRC Reconstruction of Detided Daily Sea-Level Means')

p10 <- df_mean_NOAA %>%
  filter('2014-01-01 0:00:00' <= TIME, TIME <= '2014-02-01 00:00:00') %>%
  ggplot(aes(x = TIME, y = WrightsvilleBeach)) +
  geom_point(col = 'red', size = 0.5) +
  labs(x = 'Day', y = 'Sea-level (m)', title = 'Observed (NOAA) Detided Daily Sea-Level Means')
...
p11 <- df_mean_ADCIRC %>%
  ...
  ggplot(aes(x = TIME, y = WrightsvilleBeach)) +
  geom_point(col = 'blue', size = 0.5) +
  labs(x = 'Month', y = 'Sea-level (m)', title = 'ADCIRC Reconstruction of Detided Daily Sea-Level Means')

p12 <- df_mean_NOAA %>%
  filter('2014-01-01 0:00:00' <= TIME, TIME <= '2015-01-01 00:00:00') %>%
  ggplot(aes(x = TIME, y = WrightsvilleBeach)) +
  geom_point(col = 'red', size = 0.5) +
  labs(x = 'Month', y = 'Sea-level (m)', title = 'Observed (NOAA) Detided Daily Sea-Level Means')
...
p13 <- df_mean_ADCIRC %>%
  ggplot(aes(x = TIME, y = WrightsvilleBeach)) +
  geom_point(col = 'blue', size = 0.1) +
  labs(x = 'Year', y = 'Sea-level (m)', title = 'ADCIRC Reconstruction of Detided Daily Sea-Level Means')

p14 <- df_mean_NOAA %>%
  ggplot(aes(x = TIME, y = WrightsvilleBeach)) +
  geom_point(col = 'red', size = 0.1) +
  labs(x = 'Year', y = 'Sea-level (m)', title = 'Observed (NOAA) Detided Daily Sea-Level Means')
...
p15 <- df_max_ADCIRC %>%
  ...
  geom_point(col = 'blue', size = 0.5) +
  labs(x = 'Year', y = 'Sea-level (m)', title = 'ADCIRC Reconstruction of Detided Daily Mean Sea-Level Maxima for Wrightsville each')

# single station (NOAA)
p16 <- df_max_NOAA %>%
  ggplot(aes(x = year, y = WrightsvilleBeach)) +
  geom_point(col = 'red', size = 0.5) +
  labs(x = 'Year', y = 'Sea-level (m)', title = 'Observed (NOAA) Detided Daily Mean Sea-Level Maxima for Wrightsville Beach')
...
df_max_ADCIRC %>%
  ...
  geom_point(col = 'blue', size = 0.01) +
  facet_wrap(~variable) +
  labs(x = 'Year', y = 'Sea-level (m)', title = 'Time-Series for ADCIRC Reconstruction of Detided Daily Mean Sea-Level Maxima') +
...
df_max_ADCIRC %>%
  ...
  labs(y = 'Station', x = 'sea-level (m)', title = 'Boxplots for ADCIRC Reconstruction of Detided Daily Mean Sea-Level Maxima')
...
df_max_NOAA %>%
  ...
  labs(y = 'Station', x = 'sea-level (m)', title = 'Boxplots for Observed (NOAA) Detided Daily Mean Sea-Level Maxima')
